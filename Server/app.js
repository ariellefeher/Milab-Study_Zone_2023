...
app.get("/createreservation", async(req, res) => {
  ...
  /* Step One: Updating in the Location Array */
    client.connect().then(async() => {
      ...
      let isAvailable = isbuilding.study_reservations[index].isAvailable

      
      console.log("building "+ isbuilding.location);
      console.log("day " + isbuilding.study_reservations[index].Day)
