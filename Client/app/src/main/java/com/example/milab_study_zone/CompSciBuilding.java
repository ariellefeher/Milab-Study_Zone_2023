...
public class CompSciBuilding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeNameTextView.setText("Computer Science Building");
        placeDescriptionTextView.setText("");

        Button backButtonLaw = findViewById(R.id.backButtonCompSci);
    ...
    private void reserve(final View v) {
        ...
        String location = "Computer Science Building";
    ...
    public void fetchReservations(final View v) {
        ...
        fetcher.dispatchRequest("Computer Science Building", new GetStudyZoneFetcher.GetStudyZoneResListener() {
